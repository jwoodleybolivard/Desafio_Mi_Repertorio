...
const errores = (error, res) => {
    ...
    const errorMessages = {
        ...
        '4005': "Favor revisa los datos de connexion a la base de datos al parecer una de ellas viene vacía.",
        '400': "Ninguno de los datos especificados puede estar vacíos.",
